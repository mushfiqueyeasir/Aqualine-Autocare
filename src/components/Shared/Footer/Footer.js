...
const Footer = () => {
  ...
  return (
    <footer className="bg-black bottomStick">
      <div className="container py-3">
        <div className="row">
          <div className="col-12 col-lg-4">
            <img src={logo} className="img-fluid w-25" alt="" />
            <p className="text-white">
              We care your car like our own. We do our job professionally and
              sincerely.{" "}
            </p>
          </div>
          ...
          <div className="col-6 col-lg-2  d-flex justify-content-center mt-4">
            <ul className="text-white ">
              <h4>Useful Links </h4>
              <li>
                <Link to="/result" className="Links">
                  Result
                </Link>
              </li>
              <li>
        ...
        <hr className="" />
        <h5 className="text-white text-center my-3 fs-6">
