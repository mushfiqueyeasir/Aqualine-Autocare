...
import wash from '../../../images/washer.png';
import carClean from '../../../images/wash.png';
import cleanTool from '../../../images/cleanTool.png';
        ...
        <main className='container my-5' >
            ...
            <div className="row align-items-center">
                <div className='col-12 col-lg-5 order-1 details text-center text-lg-start'>
                    ...
                    <p>Phasellus in arcu dapibus, lobortis est in, suscipit diam. Vivamus faucibus faucibus eros et porttitor. Sed est nulla, tincidunt ac ex eget, dictum mollis tortor. Vivamus faucibus nec ipsum id aliquam lobortis est.</p>

                    <h2 className='mt-5'>Call for book: <span>8-800-10-500</span> </h2>
                    <div className='my-5'>
                        <Link to='/service' className='serviceBtn'>Book Now</Link>
                ...
                <div className="col">
                    <div className="card border-endd">
                        <div className="card-body">
                            ...
                            <p className="card-text">Vestibulum tortor risus, rutrum at congue sed ultricies finibus..</p>
                        </div>
                    </div>
                </div>
                <div className="col">
                    <div className="card">
                        <div className="card-body border-endd">
                            ...
                            <p className="card-text">Cras aliquam tristique metus, eu gravida diam vestibulum gravida.</p>
                        </div>
                    </div>
                </div>
                <div className="col">
                    <div className="card">
                        <div className="card-body border-endd">
                            ...
                            <p className="card-text">Fusce maximus molestie nisl, ut dapibus libero vestibulum aliquam.</p>
                        </div>
                    </div>
                </div>
                <div className="col">
                    <div className="card border-0">
                        <div className="card-body">
                            ...
                            <p className="card-text">Sestibulum non dolor sit amet mi moles tincidunt vel non velit.</p>
                        </div>
                    </div>
                </div>
            </div>
