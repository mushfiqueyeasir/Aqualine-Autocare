        ...
        <div className='container my-5'>
            ...
            <form onSubmit={handleLogin} className="form login  wide mx-auto">
                ...
                <div className="form__field">
                    <label><i className="fa-solid fa-user-shield"></i></label>
                    <input onBlur={usernameBlur} type="text" className="form__input" placeholder="Username" required />
                </div>
                {/* Price */}
                <div className="form__field">
                    <label><i className="fa-solid fa-key"></i></label>
                    <input onBlur={passwordBlur} type="password" className="form__input" placeholder="Price" required />
                </div>
